<?php
  class user extends database {
     ...
     */
     ...
     $query = 'INSERT INTO `users` (`gender`, `lastname`, `firstname`, `birthdate`, `phone`, `mail`, `password`, `login`, `id_userRoles`) '
...
public function modifyUsers(){
 ...
 $query = 'UPDATE `users` SET `lastname` = :lastname, `firstname` = :firstname, `birthdate` = :birthdate, `phone` = :phone, `mail` = :mail '
 . 'WHERE `id` = :id';
